---
name: new-article
description: Create a new long-form article in src/content/articles/ with outline structure and draft status. Use when user wants to start writing substantial content.
