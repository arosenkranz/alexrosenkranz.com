...
description: Review uncommitted changes for code quality issues that linters miss (console.log, TODOs, hardcoded values, commented code). Use before committing code changes.
