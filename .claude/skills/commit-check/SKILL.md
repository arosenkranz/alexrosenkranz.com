---
name: commit-check
description: Validate staged changes and commit message format before committing. Checks for conventional commits format, AI attribution, and appropriate branching. Use before any git commit.
...
# Then trigger this skill by saying "check my commit"
```
