---
name: catchup
description: Restore project context at session start by reading STATUS.md, git status, and recent commits. Use when starting a new session or after clearing context.
allowed-tools: Read, Bash(git *), Bash(find *)
---
...
- This skill helps you pick up exactly where the last session left off
