...
description: Run Lighthouse performance, accessibility, and SEO audits on local production build. Use before deploying or when checking site performance.
allowed-tools: Bash(pnpm build), Bash(pnpm preview), Bash(npx lighthouse *)
---
